...
LOCAL_MODEL_DIR = Path("artifacts/xgboost_model")
TOKEN = os.getenv("HUGGINGFACE_HUB_TOKEN")
RUN_ID = "e9f5bbe17ef44daaa6d804878f739147"
COMMIT_MSG = f"Upload selected XGBoost files from MLflow run: {RUN_ID}"
...
src_model    = LOCAL_MODEL_DIR / f"model_{RUN_ID}.json"
